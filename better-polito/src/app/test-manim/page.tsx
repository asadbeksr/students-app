...
// This is the user's exact code — with imports and own Scene creation.
// ManimFrame should preprocess it to strip those and run correctly.
const script = `import {
  Scene,
  Circle,
  Dot,
...
export default function TestManim() {
  return <div className="p-8"><ManimFrame script={script} title="Sine Wave Generation from Circular Motion" /></div>;
}
