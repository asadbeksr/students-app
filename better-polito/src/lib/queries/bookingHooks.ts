...
export const useGetBookingSeats = (topicId: string, slotId: string) => useQuery({
  ...
  queryFn: () => getApiClient().getBookingSeats(topicId, slotId).then((r: any) => r.data ?? []),
